...
{
    [Table("NhapKhoHDTable")]
    [Serializable]
    public class NhapKhoHDTable
    {
        public int _iD;
        ...
        public string _hopDong;
        [NotNull]
        public string HopDong
        {
            get { return _hopDong; }
            set { this._hopDong = value; }
        }
        ...
        {
            get { return _bbgn; }
            set { this._bbgn = value; }
        }
        public string _gTGT;
        public string GTGT
        {
            get { return _gTGT; }
            set { this._gTGT = value; }
        }
        ...
        public string _iD_VTTB;
        [NotNull]
        public string ID_VTTB
        {
            get { return _iD_VTTB; }
            set { this._iD_VTTB = value; }
        }
